                ...
                <tr>
                  ...
                  <tr class="only-for-gtm <?php echo ($tracking_method != "gtm")?"tvc-hide":""; ?>">
                    <th>
                      <div class="pixel-logo-text-left">
                        <div class="pixel-logo">
                          <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL.'/admin/images/track-selected-events.png'); ?>"/>
                        </div>
                        <div class="pixel-text">
                          <label><?php esc_html_e("Select events to track:","enhanced-e-commerce-for-woocommerce-store"); ?></label>                          
                        </div>
                      </div>
                    </th>
                    <td>
                      <div class="ga_conv_event_selection">
                      <select class="conv_multiselect2_input" id="ga_selected_events" name="conv_selected_events[ga][]" multiple="multiple" required data-placeholder="Select event">
                          <?php 
                ...
                <tbody>
                  ...
                  <tr>
                    <th>
                      <div class="pixel-logo-text-left">                        
                        <div class="pixel-text ml-40">
                          <label><?php esc_html_e("Meta (Facebook) Conversion API token","enhanced-e-commerce-for-woocommerce-store"); ?><?php if($plan_id==1){ ?>
                            <a target="_blank" href="<?php echo esc_url_raw($TVC_Admin_Helper->get_pro_plan_site().'?utm_source=EE+Plugin+User+Interface&utm_medium=Pixel+Settings+upgrading+Pro+to+Use+Facebook+Conversion+API&utm_campaign=Upsell+at+Conversios'); ?>" class="tvc-pro"> (PRO)</a> 
                            <?php } ?></label>
                    ...
                    <td>
                      ...
                      <textarea class="fromfiled" name="fb_conversion_api_token" placeholder="Meta (Facebook) Conversion API token" id="fb_conversion_api_token" <?php if($plan_id==1){ ?>disabled<?php } ?>><?php echo esc_attr($fb_conversion_api_token); ?></textarea>
                      <small>Send events directly from your web server to Facebook through the Conversion API.</small>
                    </td>
                  </tr>
              ...
              <div class="sec_con_integration" id="sec_con_integration_GAds">
                ...
                <?php if($plan_id != 1 && isset($googleDetail->google_ads_id) && $googleDetail->google_ads_id != ''){ ?>
                  ...
                  <div class="form-group google_ads_conversion_sec" id="google_ads_conversion_sec">
                    ...
                    <div class='google_conversion_label_message alert alert-danger google_ads_conversion_label_message tvc-hide' role='alert'>
                      <?php esc_html_e("No conversion labels are retrived, kindly refresh once else check if conversion label is available in your google ads account.","enhanced-e-commerce-for-woocommerce-store");?>
                        <br>
                        <?php esc_html_e("Or","enhanced-e-commerce-for-woocommerce-store");?>
                        <br>
                        <?php esc_html_e("Enter it manually in below input box.","enhanced-e-commerce-for-woocommerce-store");?>
                        <br><br>
                        <small>
                    ...
                    <div class="form-group google_ads_conversion_sec_static tvc-hide">
                      <hr>  
                      <table class="table" >
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <input type="text" name="ee_conversio_send_to_static" class="fromfiled" id="ee_conversio_send_to_static" placeholder="AW-10963589342/MrYuCJmY0dIDEN6x7Oso" style="min-width:320px;" value="<?php echo $ee_conversio_send_to; ?>">
                              <small style="color:red;" id="ee_conversio_send_to_static_msg" class="tvc-hide">
                                <?php esc_html_e("Please enter an valid Google Ads Conversion Id and Label", "enhanced-e-commerce-for-woocommerce-store"); ?>
                              </small>
                            </td>
                          </tr>
                        </tbody>
                  ...
                  ?>
                  <label class="align-middle">
                    <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL.'/admin/images/config-success.svg'); ?>" class="config-success"><label class="custom-control-label"><?php esc_html_e("Enable Google Ads conversion tracking","enhanced-e-commerce-for-woocommerce-store"); ?></label>
                  </label>
                  <label class="align-middle">
                    <img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL.'/admin/images/config-success.svg'); ?>" class="config-success"><label class="custom-control-label"><?php esc_html_e("Enable Google Ads Enhanced conversion tracking","enhanced-e-commerce-for-woocommerce-store"); ?></label>
                  </label>
                  <?php
                }else{?>               
                  <label class="align-middle">
