			                    ...
			                    <!-- Advance Settings-->
					              ...
					              <div class="con_pixels_sec">					              	
					              	...
					              	<div class="form-row con_onboarding_sub_sec">
				              				...
				              				<div class="col-sm-4 pixel-left-sec">
						              			<div class="pixel-logo-text-left">						              				
						              				<div class="pixel-text ml-40">
						              					<label><?php esc_html_e("Meta (Facebook) Conversion API token:","enhanced-e-commerce-for-woocommerce-store"); ?><?php if($this->plan_id==1){ ?>
				                            	<a target="_blank" href="<?php echo esc_url_raw($this->TVC_Admin_Helper->get_pro_plan_site().'?utm_source=EE+Plugin+User+Interface&utm_medium=Onboarding+upgrading+Pro+to+Use+Facebook+Conversion+API&utm_campaign=Upsell+at+Conversios'); ?>" class="tvc-pro"> (PRO)</a> 
				                            <?php } ?></label>
					                      ...
					                      <textarea class="fromfiled" name="fb_conversion_api_token" <?php if($this->plan_id==1){ ?>disabled<?php } ?> placeholder="Meta (Facebook) Conversion API token" id="fb_conversion_api_token"><?php echo esc_attr($fb_conversion_api_token); ?></textarea>
