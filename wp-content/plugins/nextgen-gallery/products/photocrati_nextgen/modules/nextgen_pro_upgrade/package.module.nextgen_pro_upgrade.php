...
class A_NextGen_Pro_Upgrade_Controller extends Mixin
{
    ...
    public function get_marketing_blocks()
    {
        ...
        $retval[] = new C_Marketing_Block_Card(__('Film Gallery', 'nggallery'), __('Want to sell your images directly in your WordPress site? NextGEN Pro adds a true image ecommerce system to help you do just that. Accept PayPal, Stripe, and Checks with ease!', 'nggallery'), 'film-gallery.svg', $medium, 'filmgallery');
