...
?>
	...
	<div id="primary" class="content-area">
		...
		<div class="site-hero site-hero-parallax">
            <div class="site-hero-cover" data-parallax="scroll" data-image-src="<?php the_field('wheels_info_background', 'option'); ?>">
		...
		<div class="site-wheels-filters">
			...
			<ul class="site-wheels-filters-list">
				...
				<li>
					<select class="site-wheels-filters site-wheels-filters-options site-wheels-filters-products">
						<option value="">All</option>
						<?php
							$terms = get_terms( 'wheel_category' );
							if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) :
							foreach ( $terms as $term )  :
							if ($term->slug != 'new-arrivals') :
						 ?>
		...
		<ul class="site-wheels-list">
			...
			<li class="<?php
				...
				$terms = get_the_terms( $post->ID, 'wheel_category' );
				if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) :
				foreach ( $terms as $term )  :
				echo $term->slug . ' ';
				endforeach;
