...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-67424349-3"></script>
	<script>
	window.dataLayer = window.dataLayer || [];
	function gtag(){dataLayer.push(arguments);}
	gtag('js', new Date());
	gtag('config', 'UA-67424349-3');
	</script>
...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<div class="site-branding">
			...
			<a class="site-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri() ?>/images/ui/logo.svg"></a>
		...
		<nav id="site-navigation" class="main-navigation">
			<div class="main-navigation-inner">
				<a class="menu-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri() ?>/images/ui/logo-white.svg"></a>
				<?php
				wp_nav_menu( array(
				...
				<ul class="site-stockists-options">
					...
					<li>
						<label class="checkbox">
							<input type="hidden" name="categories[]" value="riviera-wheels" checked />
						</label>
					</li>
